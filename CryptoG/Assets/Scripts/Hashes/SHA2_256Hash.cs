...
public class SHA2_256Hash : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log(SHA2_256(userInput));
    }

    private string SHA2_256(string input)
    {
        ...
        string hexH = UtilityFunc.BinaryToHex(UtilityFunc.UintToBinary(hMain));
